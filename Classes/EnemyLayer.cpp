...
void EnemyLayer::addEnemy1(float dt)
{
	...
	int actualDuration=(int)((rand()%rangeDuration)+minDuration);
...
void EnemyLayer::enemy1Blowup(Enemy* enemy1)
{
	...
	CCSequence* sequence=CCSequence::createWithTwoActions(animate,removeEnemy1);
...
void EnemyLayer::enemy2Blowup(Enemy* enemy2)
{
	...
	CCSequence* sequence=CCSequence::createWithTwoActions(animate,removeEnemy2);
...
void EnemyLayer::enemy3Blowup(Enemy* enemy3)
{
	...
	CCSequence* sequence=CCSequence::createWithTwoActions(animate,removeEnemy3);
