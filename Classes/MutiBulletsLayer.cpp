...
void MutiBulletsLayer::AddMutiBullets(float dt)
{
	...
	CCSequence* sequenceLeft=CCSequence::createWithTwoActions(actionLeftMove,actionLeftDone);
	...
	CCSequence* sequenceRight=CCSequence::createWithTwoActions(actionRightMove,actionRightDone);
